...
export class LBusInd extends CEMIMessage {
    constructor(
     ...
     * @returns {LBusInd}
     */
    static createFromBuffer(buffer: Buffer, offset: number = 0): LBusInd {
        ...
        return new LBusInd(additionalInfo, controlField, srcAddress, dstAddress, npdu);
    }
